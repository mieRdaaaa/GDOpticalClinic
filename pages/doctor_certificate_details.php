...
<main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all">
    ...
    <a href="doctor_delete_certificate.php?id=<?php echo htmlspecialchars($certificate['certificate_id']); ?>" class="bg-red-500 text-white py-2 px-4 rounded hover:bg-red-600 text-lg" onclick="return confirm('Are you sure you want to delete this certificate?');">
