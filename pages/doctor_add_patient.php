...
<div class="mb-4">
    ...
    <textarea id="additional_notes" name="additional_notes" class="border border-gray-300 rounded-md py-2 px-4 w-full" placeholder="Enter any additional notes"></textarea>
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium mb-1">Street Name, Building, House No.:</label>
                <input type="text" select id="street" name="street" class="block w-full border border-gray-300 rounded-md py-2 px-4" placeholder="Enter last name" required>
            </div>
