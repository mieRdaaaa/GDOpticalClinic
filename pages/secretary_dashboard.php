...
$sql = "SELECT first_name, middle_name, last_name, gender, date_added FROM patients ORDER BY date_added DESC LIMIT 9";
$result = $conn->query($sql);
            ...
            <li class="flex items-center mb-2 border-b border-gray-200 pb-2">
                ...
                <div class="flex items-center justify-between flex-grow">
                    <div class="flex items-center">
                        ...
                        <!-- NEW Badge -->
                        <span class="bg-red-500 text-white text-xs font-semibold rounded-full px-2 py-1 ml-2">
                            NEW
                        </span>
                    </div>
